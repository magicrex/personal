...
class DocInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:doc_index_proto.DocInfo) */ {
 public:
  ...
  inline DocInfo* New() const final {
    return CreateMaybeMessage<DocInfo>(NULL);
  }

  DocInfo* New(::google::protobuf::Arena* arena) const final {
  ...
  bool has_title_token() const;
  void clear_title_token();
  static const int kTitleTokenFieldNumber = 6;
  private:
  const ::doc_index_proto::Pair& _internal_title_token() const;
  public:
  const ::doc_index_proto::Pair& title_token() const;
  ::doc_index_proto::Pair* release_title_token();
  ::doc_index_proto::Pair* mutable_title_token();
  void set_allocated_title_token(::doc_index_proto::Pair* title_token);

  // required .doc_index_proto.Pair content_token = 7;
  bool has_content_token() const;
  void clear_content_token();
  static const int kContentTokenFieldNumber = 7;
  private:
  const ::doc_index_proto::Pair& _internal_content_token() const;
  public:
  const ::doc_index_proto::Pair& content_token() const;
  ::doc_index_proto::Pair* release_content_token();
  ::doc_index_proto::Pair* mutable_content_token();
  void set_allocated_content_token(::doc_index_proto::Pair* content_token);
 ...
 private:
  ...
  void set_has_title_token();
  void clear_has_title_token();
  void set_has_content_token();
  void clear_has_content_token();
  ...
  ::doc_index_proto::Pair* title_token_;
  ::doc_index_proto::Pair* content_token_;
...
class KwdInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:doc_index_proto.KwdInfo) */ {
 public:
  ...
  inline KwdInfo* New() const final {
    return CreateMaybeMessage<KwdInfo>(NULL);
  }

  KwdInfo* New(::google::protobuf::Arena* arena) const final {
  ...
  bool has_doc_list() const;
  void clear_doc_list();
  static const int kDocListFieldNumber = 2;
  private:
  const ::doc_index_proto::Weight& _internal_doc_list() const;
  public:
  const ::doc_index_proto::Weight& doc_list() const;
  ::doc_index_proto::Weight* release_doc_list();
  ::doc_index_proto::Weight* mutable_doc_list();
  void set_allocated_doc_list(::doc_index_proto::Weight* doc_list);

  // @@protoc_insertion_point(class_scope:doc_index_proto.KwdInfo)
 private:
  void set_has_key();
  void clear_has_key();
  void set_has_doc_list();
  void clear_has_doc_list();
  ...
  ::doc_index_proto::Weight* doc_list_;
  friend struct ::protobuf_index_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Index : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:doc_index_proto.Index) */ {
 public:
  ...
  private:
  const ::doc_index_proto::KwdInfo& _internal_inverted_index() const;
  public:
  const ::doc_index_proto::KwdInfo& inverted_index() const;
  ::doc_index_proto::KwdInfo* release_inverted_index();
  ::doc_index_proto::KwdInfo* mutable_inverted_index();
  void set_allocated_inverted_index(::doc_index_proto::KwdInfo* inverted_index);

  // @@protoc_insertion_point(class_scope:doc_index_proto.Index)
 private:
  void set_has_inverted_index();
  void clear_has_inverted_index();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::doc_index_proto::DocInfo > forward_index_;
  ::doc_index_proto::KwdInfo* inverted_index_;
  friend struct ::protobuf_index_2eproto::TableStruct;
};
// ===================================================================
...
inline ::std::string* DocInfo::release_show_url() {
  ...
  clear_has_show_url();
  return show_url_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* DocInfo::release_jump_url() {
  ...
  clear_has_jump_url();
  return jump_url_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
// required .doc_index_proto.Pair title_token = 6;
inline bool DocInfo::has_title_token() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void DocInfo::set_has_title_token() {
  _has_bits_[0] |= 0x00000010u;
}
inline void DocInfo::clear_has_title_token() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void DocInfo::clear_title_token() {
  if (title_token_ != NULL) title_token_->Clear();
  clear_has_title_token();
}
inline const ::doc_index_proto::Pair& DocInfo::_internal_title_token() const {
  return *title_token_;
}
inline const ::doc_index_proto::Pair& DocInfo::title_token() const {
  const ::doc_index_proto::Pair* p = title_token_;
...
inline ::doc_index_proto::Pair* DocInfo::release_title_token() {
  // @@protoc_insertion_point(field_release:doc_index_proto.DocInfo.title_token)
  clear_has_title_token();
  ::doc_index_proto::Pair* temp = title_token_;
  title_token_ = NULL;
  return temp;
}
inline ::doc_index_proto::Pair* DocInfo::mutable_title_token() {
  set_has_title_token();
  if (title_token_ == NULL) {
    auto* p = CreateMaybeMessage<::doc_index_proto::Pair>(GetArenaNoVirtual());
    title_token_ = p;
  }
  // @@protoc_insertion_point(field_mutable:doc_index_proto.DocInfo.title_token)
  return title_token_;
}
inline void DocInfo::set_allocated_title_token(::doc_index_proto::Pair* title_token) {
  ...
  if (title_token) {
    ...
    if (message_arena != submessage_arena) {
      title_token = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, title_token, submessage_arena);
    }
    set_has_title_token();
  } else {
    clear_has_title_token();
  }
  title_token_ = title_token;
  // @@protoc_insertion_point(field_set_allocated:doc_index_proto.DocInfo.title_token)
}

// required .doc_index_proto.Pair content_token = 7;
inline bool DocInfo::has_content_token() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void DocInfo::set_has_content_token() {
  _has_bits_[0] |= 0x00000020u;
}
inline void DocInfo::clear_has_content_token() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void DocInfo::clear_content_token() {
  if (content_token_ != NULL) content_token_->Clear();
  clear_has_content_token();
}
inline const ::doc_index_proto::Pair& DocInfo::_internal_content_token() const {
  return *content_token_;
}
inline const ::doc_index_proto::Pair& DocInfo::content_token() const {
  const ::doc_index_proto::Pair* p = content_token_;
  // @@protoc_insertion_point(field_get:doc_index_proto.DocInfo.content_token)
  return p != NULL ? *p : *reinterpret_cast<const ::doc_index_proto::Pair*>(
      &::doc_index_proto::_Pair_default_instance_);
}
inline ::doc_index_proto::Pair* DocInfo::release_content_token() {
  // @@protoc_insertion_point(field_release:doc_index_proto.DocInfo.content_token)
  clear_has_content_token();
  ::doc_index_proto::Pair* temp = content_token_;
  content_token_ = NULL;
  return temp;
}
inline ::doc_index_proto::Pair* DocInfo::mutable_content_token() {
  set_has_content_token();
  if (content_token_ == NULL) {
    auto* p = CreateMaybeMessage<::doc_index_proto::Pair>(GetArenaNoVirtual());
    content_token_ = p;
  }
...
inline void DocInfo::set_allocated_content_token(::doc_index_proto::Pair* content_token) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete content_token_;
  }
  if (content_token) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      content_token = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, content_token, submessage_arena);
    }
    set_has_content_token();
  } else {
    clear_has_content_token();
  }
  content_token_ = content_token;
  // @@protoc_insertion_point(field_set_allocated:doc_index_proto.DocInfo.content_token)
}
...
// required .doc_index_proto.Weight doc_list = 2;
inline bool KwdInfo::has_doc_list() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void KwdInfo::set_has_doc_list() {
  _has_bits_[0] |= 0x00000002u;
}
inline void KwdInfo::clear_has_doc_list() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void KwdInfo::clear_doc_list() {
  if (doc_list_ != NULL) doc_list_->Clear();
  clear_has_doc_list();
}
inline const ::doc_index_proto::Weight& KwdInfo::_internal_doc_list() const {
  return *doc_list_;
}
inline const ::doc_index_proto::Weight& KwdInfo::doc_list() const {
  const ::doc_index_proto::Weight* p = doc_list_;
  // @@protoc_insertion_point(field_get:doc_index_proto.KwdInfo.doc_list)
  return p != NULL ? *p : *reinterpret_cast<const ::doc_index_proto::Weight*>(
      &::doc_index_proto::_Weight_default_instance_);
}
inline ::doc_index_proto::Weight* KwdInfo::release_doc_list() {
  // @@protoc_insertion_point(field_release:doc_index_proto.KwdInfo.doc_list)
  clear_has_doc_list();
  ::doc_index_proto::Weight* temp = doc_list_;
  doc_list_ = NULL;
  return temp;
}
inline ::doc_index_proto::Weight* KwdInfo::mutable_doc_list() {
  set_has_doc_list();
  if (doc_list_ == NULL) {
    auto* p = CreateMaybeMessage<::doc_index_proto::Weight>(GetArenaNoVirtual());
    doc_list_ = p;
  }
  // @@protoc_insertion_point(field_mutable:doc_index_proto.KwdInfo.doc_list)
  return doc_list_;
}
inline void KwdInfo::set_allocated_doc_list(::doc_index_proto::Weight* doc_list) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete doc_list_;
  }
  if (doc_list) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      doc_list = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, doc_list, submessage_arena);
    }
    set_has_doc_list();
  } else {
    clear_has_doc_list();
  ...
  doc_list_ = doc_list;
  // @@protoc_insertion_point(field_set_allocated:doc_index_proto.KwdInfo.doc_list)
}
...
// required .doc_index_proto.KwdInfo inverted_index = 2;
inline bool Index::has_inverted_index() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Index::set_has_inverted_index() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Index::clear_has_inverted_index() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Index::clear_inverted_index() {
  if (inverted_index_ != NULL) inverted_index_->Clear();
  clear_has_inverted_index();
}
inline const ::doc_index_proto::KwdInfo& Index::_internal_inverted_index() const {
  return *inverted_index_;
}
inline const ::doc_index_proto::KwdInfo& Index::inverted_index() const {
  const ::doc_index_proto::KwdInfo* p = inverted_index_;
  // @@protoc_insertion_point(field_get:doc_index_proto.Index.inverted_index)
  return p != NULL ? *p : *reinterpret_cast<const ::doc_index_proto::KwdInfo*>(
      &::doc_index_proto::_KwdInfo_default_instance_);
}
inline ::doc_index_proto::KwdInfo* Index::release_inverted_index() {
  // @@protoc_insertion_point(field_release:doc_index_proto.Index.inverted_index)
  clear_has_inverted_index();
  ::doc_index_proto::KwdInfo* temp = inverted_index_;
  inverted_index_ = NULL;
  return temp;
}
inline ::doc_index_proto::KwdInfo* Index::mutable_inverted_index() {
  set_has_inverted_index();
  if (inverted_index_ == NULL) {
    auto* p = CreateMaybeMessage<::doc_index_proto::KwdInfo>(GetArenaNoVirtual());
    inverted_index_ = p;
  }
  // @@protoc_insertion_point(field_mutable:doc_index_proto.Index.inverted_index)
  return inverted_index_;
}
inline void Index::set_allocated_inverted_index(::doc_index_proto::KwdInfo* inverted_index) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  if (inverted_index) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      inverted_index = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, inverted_index, submessage_arena);
    }
    set_has_inverted_index();
  } else {
    clear_has_inverted_index();
  ...
  // @@protoc_insertion_point(field_set_allocated:doc_index_proto.Index.inverted_index)
}
